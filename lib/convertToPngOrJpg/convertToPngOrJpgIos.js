...
const convertToPngOrJpgIos = (path, height, width, outputFile, fileType, fileUri, heightIPad, widthIPad, pathIpad) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (heightIPad && widthIPad) {
        const contentsImageIpad = yield generateForEveryScale(pathIpad != undefined ? pathIpad : inputFilePath, widthIPad, heightIPad, fileName, outputFile, folderName, fileType, type, true);
