...
if (!fs.existsSync(imageFolder)) {
    const constantsContent = fs.readFileSync("./node_modules/@chouicgames/react-native-images-to-native-images/script/commonImage/Images.ts");
    const typesContent = fs.readFileSync("./node_modules/@chouicgames/react-native-images-to-native-images/script/commonImage/ImagesTypes.ts");
