...
if (!fs.existsSync(imageFolder)) {
    const constantsContent = fs.readFileSync("./node_modules/react-native-images-to-native-images/script/commonImage/constants.ts");
    const typesContent = fs.readFileSync("./node_modules/react-native-images-to-native-images/script/commonImage/types.ts");
